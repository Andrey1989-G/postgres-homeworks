...
-- 1. Название компании заказчика (company_name из табл. company_name) и ФИО сотрудника, работающего над заказом этой компании (см таблицу employees),
...
WHERE customers.city ='London' AND employees.city ='London' AND s.company_name = 'United Package';
